<?php /* Smarty version Smarty-3.0.5, created on 2010-12-13 01:49:47
         compiled from "D:\project\janbao\kpanel\admin/views/default\controltop.html" */ ?>
<?php /*%%SmartyHeaderCode:30524d057bbbcb9440-44704357%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2598015351f60f604a420cd86de1a2dee24cf250' => 
    array (
      0 => 'D:\\project\\janbao\\kpanel\\admin/views/default\\controltop.html',
      1 => 1289015572,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30524d057bbbcb9440-44704357',
  'function' => 
  array (
  ),
...
function shift_status()
{
	...
	if(flag)
	{
		if(screen.height>768)
			...
			rightFrame.rows = "64,9,*";
		document.getElementById('menuSwitch1').src='images/ej1_31.gif';
		document.getElementById('menuSwitch1').title='隐藏';
	}
	else
	{
		rightFrame.rows = "0,9,*";
		document.getElementById('menuSwitch1').src='images/ej1_31a.gif';
...
<BODY onclick="shift_status()" leftmargin=0 topmargin=0 onLoad="restoreLocale()"  bgcolor="#DCDCDC">
<span class="cacher" id="cacheData" name="cacheData"></span>
<table width="100%" height="9" border=0 cellpadding="0" cellspacing="0">
	<tr>
	 <td align="center" bgcolor="#DCDCDC" id=menuSwitch style="cursor:hand"><img src="images/ej1_31.gif" name="menuSwitch1" height="9" id=menuSwitch1></td>
	</tr>
</table>
</BODY>
</HTML>