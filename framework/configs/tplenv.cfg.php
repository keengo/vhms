...
$GLOBALS['tplenv']['html'][] = array('name'=>'TOMCAT_PASSWD','password'=>1,'count'=>1,'value'=>array('TEXT','/^[a-z0-9A-Z_]{2,16}$/'));
$GLOBALS['tplenv']['html'][] = array('name'=>'ZEND','count'=>1,'value'=>array('RADIO',array(array('ON',''),array('OFF',';'))));
