<?php
$GLOBALS['settingrule']['alipay']['ALIPAY_SELLER_EMAIL'] = array('name'=>'ALIPAY_SELLER_EMAIL','value'=>array('TEXT','/^[a-z0-9A-Z_]{2,32}@[a-z0-9A-Z_]{2,32}.[a-z]{2,32}$/',32));
...
$GLOBALS['settingrule']['alipay']['ALIPAY_DOMAIN'] = array('name'=>'ALIPAY_DOMAIN','value'=>array('TEXT','/^[a-z]{3,12}.[a-z0-9A-Z]{2,64}.[a-z]{2,8}$/',32));
...
$GLOBALS['lang']['zh_CN']['ALIPAY_DOMAIN'] = '网站域名';
?>